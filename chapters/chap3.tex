...
Ci poniamo ora il problema di studiare come si modificano i teoremi di limit\textit{atezza/continuità/integrabilità/integrabilità/derivabilità} visti nel \refChapter{convergenzafunzioni} nel caso delle \textit{serie di funzioni}.
