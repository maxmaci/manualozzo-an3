...
\subsection{Definizione assiomarica di misura}
...
\begin{examples}\textsc{Spazi di misura.}
	...
	\end{equation}
Se $\displaystyle\sum_{n\colon x_n\in E}p_n=1$ è una \textbf{misura di probabilità discreta}\index{misura!di probabilità discreta}, come la m.d.p. \textit{binomiale}, di \textit{Poisson}, ecc...\\
