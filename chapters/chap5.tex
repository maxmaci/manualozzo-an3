...
%fastidiosamente c'è un punto a capo da solo
	...
	\end{define}
%NEW: riformulazione
	Per qualsiasi insieme test $E$ insiemisticamente si ha che $E=(E\cap A) \cup (E\cap A^C)$. Si impone che $A$ è misurabile se per qualsiasi \textbf{insieme test}\index{insieme!test} arbitrario (non necessariamente misurabile!) la misura $m_n^X$ è additiva su questa decomposizione
%OLD
...
È importante sottolineare che ci sono insiemi misurabili \textit{non} Boreliani.
