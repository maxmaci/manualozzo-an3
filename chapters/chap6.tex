...
\begin{equation*}
	\lvert f\rvert_1 = 0 \iff f\equiv 0\text{ q.o. in }\left[a,b\right]\iff f\equiv 0\text{ su }\left[a,b\right]\text{ perché continua}
\end{equation*}
...
\begin{define}[Integrali dipendenti da un parametro.]~{}\\
	...
	\begin{equation}
		F\left(t\right)=\int_If\left(t,x\right)dm_1\left(x\right),\ \forall t\in J
	\end{equation}
dove $I,J$ sono intervalli in $\realset$ e
\begin{equation*}
	\funztot{f}{I\times J}{\complexset}{\left(t,x\right)}{f\left(t,x\right)}
\end{equation*}
...
\begin{theorema}[Teorema di continuità e derivabilità di integrali dipendenti da un parametro.]~{}\\
	...
	\begin{equation*}
		F\left(t\right)=\int_If\left(t,x\right)dm_1\left(x\right)
	\end{equation*}
	\begin{enumerate}
		\item Se
		\begin{itemize}
			...
			\begin{equation*}
				\abs{f\left(t,x\right)}\leq\phi\left(x\right),\ \forall \left(t,x\right)\in I\times J
			\end{equation*}
		\end{itemize}
