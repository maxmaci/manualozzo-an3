...
%NOTA: non è lo stesso controesempio di prima che hai pure citato? perché riscriverlo?
\begin{example}
	Consideriamo la successione
	\begin{equation*}
		f_n(x)=\chi_{(n,n+1)}(x)=
...
\begin{examplewt}[Convergenza in $L^1$ non implica C.U.]
	Consideriamo la successione
	\begin{equation*}
