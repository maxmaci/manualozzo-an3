...
\begin{demonstrationcaput}
	...
	\end{equation*}
	$\impliessx$ Prima di provare questa implicazione, ci serve un risultato preliminare e più generici:
	\begin{itemize}
...
\end{equation*}
Per il punto II. segue che $f=0$ \textbf{q.o.} su $X$. Si osservi che se $f$ si limita ad avere valori in $\left[0,+\infty\right)$ la conclusione si ottiene direttamente per il punto III. della proprietà. in quanto $\abs{f}=f$.
