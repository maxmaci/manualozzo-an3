...
\begin{theorema}[Converge uniforme delle serie di potenze.]~{}\\\label{convergenzasottoinsiemeH}
	...
	\end{enumerate}
\end{theorema}
\begin{demonstration} Per questa dimostrazione useremo il \textit{criterio di Weierstrass}\footnote{Si veda \refChapterOnly{seriefunzioni}, sezione \ref{criteriodiweierstrass}, pag. \pageref{criteriodiweierstrass}.}.
	\begin{enumerate}
