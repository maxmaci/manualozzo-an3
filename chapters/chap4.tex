...
\begin{introduction}
	...
	\end{flushright}
\end{introduction}
\lettrine[findent=1pt, nindent=0pt]{N}{el} \refChapterOnly{seriefunzioni} abbiamo iniziato definito cos'è una serie di funzioni. Ora studieremo un particolare tipo di funzioni, le potenze, e le serie ad esse associate.
...
\begin{demonstration}\textsc{(del Teorema di derivabilità della somma di una serie di potenze.)}\\% TO DO: add title to demonstration in preamble
...
\end{equation*}
\end{itemize}
\end{demonstration}% TO DO: add title to digression in preamble
